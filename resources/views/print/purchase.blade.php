                        ...
                        <div class="invoice p-3 mb-3">
                            ...
                            <div class="row invoice-info">
                                ...
                                <div class="col-sm-4 invoice-col">
                                    To
                                    <address>
                                        <strong>{{ $data['purchases']['supplier']['name'] }}</strong><br>
                                        {{$data['purchases']['supplier']['address']}}<br>
                                        Phone: {{$data['purchases']['supplier']['phone']}}<br>
                                        Email: {{$data['purchases']['supplier']['email']}}
                                    </address>
                                </div>
                                <!-- /.col -->
                                <div class="col-sm-4 invoice-col">
                                    <b>Invoice #{{ $data['purchases']['invoice_code'] }}</b><br>
                                    <br>
                                    <b>Payment Date:</b> {{ date('Y-m-d'),strtotime($data['purchases']['updated_at']) }}<br>
                                    <b>Amount:</b> {{ $data['purchases']['net_total'] }} Tk
                                </div>
                                <!-- /.col -->
                            </div>
                            <!-- /.row -->
                            ...
                            <div class="row">
                                <div class="col-12 table-responsive">
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                        @foreach($data['purchases']['purchase_details'] as $key=> $value)
                                        <tr>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table">
                                            <tr>
                                                ...
                                                <td>{{ $data['purchases']['gross_total'] }} tk</td>
                                            </tr>
                                            <tr>
                                                <th>Discount:</th>
                                                <td>{{ $data['purchases']['discount'] }} tk</td>
                                            </tr>
                                            <tr>
                                                <th>Net Total:</th>
                                                <td>{{ $data['purchases']['net_total'] }} tk</td>
                                            </tr>
                                        </table>
                                    </div>
                                </div>
