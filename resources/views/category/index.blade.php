...
@section('title-card-small','Manage category')
@section('timelineBar')
...
@section('content')
    ...
    <p><a href="{{ route('categories.create') }}" class="btn btn-info"><i class="fas fa-plus"></i> Category</a></p>
    @endif
    <div class="card">
            ...
            <table class="table table-bordered table-striped table-sm" id="dataTable">
                ...
                @foreach($data['data'] as $key => $value)
                    <tr>
                        ...
                        @endif
                        <td style="width: 17%"><a href="{{ route('categories.show', $value['id']) }} " class="btn btn-default"><i
                                    class="fa fa-eye" aria-hidden="true"></i></a>
                            @if($user_type == 'manager')
                            <a href="{{ route('categories.edit', $value['id']) }} " class="btn btn-info"><i
